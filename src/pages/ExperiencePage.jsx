...
const ExperiencePage = () => {
  ...
  const lifeRace = [
    { id: 1, type: 'education', title: 'Start!', subtitle: '중앙대학교 물리학과 졸업', date: '2022-02-14', description: '물리학 전공, 아직 뭘 하고 싶은지 몰랐던 상태 (전적대 : 아주대)', icon: '🎓', color: '#4CAF50', isMilestone: true },
